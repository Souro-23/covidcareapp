  ...
  return (
    <>
      ...
      <Row justify='center'>
        <Col sm={16} xs={20}>
          <h2>
            <b>What all you can do at home to fight this pandemic?</b>
          </h2>
        </Col>
      </Row>
      <br />
      <Row justify='center'>
        <Col lg={5} md={11} sm={11} xs={20}>
          <div className={classes.actionCard1}>
            ...
            <p>
              {" "}
              Learn Powerful Breathing Techniques like to help your lungs fight
              the deadly disease and boost your immunity and fight
              stress/anxiety
            </p>
