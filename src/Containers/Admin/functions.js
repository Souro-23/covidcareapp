...
export const getDatabaseVariables = (database) => {
  switch (database) {
    ...
    case "Food":
      return ["name", "phone", "streetNumber", "location", "verified", "isFree"];
    case "Doctors": 
      return ["name", "phone", "whatsappNo", "MCINumber", "specialization" , "consultTime"];
    case "Patients":
      return ["name", "phone", "age", "symptoms" , "testedPositive"];
    case "Donors":
      return ["name", "phone", "gender", "bloodGroup" , "screeningDate" , "location"];
    case "Recipients":
      return ["name", "phone", "gender", "bloodGroup" , "screeningDate" , "location"];      
    default:
      break;
