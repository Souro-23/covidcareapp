...
export class HospitalBedsTable extends Component {
  constructor(props) {
    super(props);
    this.columns = [
      {
  ...
  handleSave = (row) => {
    if (row.newItem) {
      db.collection("HospitalBeds").add({
        name: row.name ? row.name : "",
        phone: row.phone ? row.phone : "",
        bedsInfo: row.bedsInfo ? row.bedsInfo : "",
  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <br />
        <BulkUpload database = "HospitalBeds" />
        <br />
        <br />
      </div>
    );
