...
export default function BulkUpload({ database }) {
    ...
    return (
        <div style={{ height: "100px", backgroundColor: "white", borderRadius: "10px", display: "flex", justifyContent: 'center', alignItems: 'center' }}>
            <input ref={fileInput}   type="file" onChange={fileHandler} />
            {data && <Button onClick={() => uploadData(data)} loading={loading}> Upload</Button>}
