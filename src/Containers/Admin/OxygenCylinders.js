...
export class OxygenCylinders extends Component {
    constructor(props) {
        super(props);
        this.columns = [
            {
        ...
        db.collection("OxygenCylinders").orderBy("timestamp", "desc").onSnapshot((querySnapshot) => {
            var data = []
    ...
    handleDelete = (key) => {
        ...
        db.collection("OxygenCylinders").doc(key).delete().then(() => {
