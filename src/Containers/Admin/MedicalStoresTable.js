...
export class MedicalStoresTable extends Component {
  constructor(props) {
    super(props);
    this.columns = [
      {
  ...
  handleSave = (row) => {
    if (row.newItem) {
      db.collection("MedicalStores").add({
        name: row.name ? row.name : "",
        phone: row.phone ? row.phone : "",
        medicines: row.medicines ? row.medicines : "",
  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <br />
        <BulkUpload database = "MedicalStores" />
        <br />
        <br />
      </div>
    );
...
export default MedicalStoresTable;
